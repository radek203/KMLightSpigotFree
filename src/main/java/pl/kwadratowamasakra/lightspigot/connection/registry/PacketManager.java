...
public class PacketManager {
    ...
    public final void registerPackets(final LightSpigotServer server) {
        ...
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x00), PacketKeepAliveIn.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x01), PacketChatMessage.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x02), PacketUseEntity.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x03), PacketPlayer.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x04), PacketPlayer.PacketPlayerPosition.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x05), PacketPlayer.PacketPlayerLook.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x06), PacketPlayer.PacketPlayerPosLook.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x07), PacketPlayerDigging.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x08), PacketPlayerBlockPlacement.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x09), PacketHeldItemChange.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x0A), PacketAnimation.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x0B), PacketEntityAction.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x0C), PacketInput.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x0D), PacketCloseWindow.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x0E), PacketClickWindow.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x0F), PacketConfirmTransaction.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x10), PacketCreativeInventoryAction.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x11), PacketEnchantItem.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x12), PacketUpdateSign.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x13), PacketPlayerAbilitiesIn.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x14), PacketTabComplete.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x15), PacketClientSettings.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x16), PacketClientStatus.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x17), PacketCustomPayload.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x18), PacketSpectate.class);
        registerPacket(server, PacketDirection.IN, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x19), PacketResourcePackStatus.class);

        registerPacket(server, PacketDirection.OUT, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x00), PacketKeepAliveOut.class);
        registerPacket(server, PacketDirection.OUT, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x01), PacketJoinGame.class);
        registerPacket(server, PacketDirection.OUT, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x02), PacketChat.class);
        registerPacket(server, PacketDirection.OUT, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x08), PacketPlayerPosLook.class);
        registerPacket(server, PacketDirection.OUT, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x2F), PacketPlaySetSlot.class);
        registerPacket(server, PacketDirection.OUT, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x34), PacketPlayMap.class);
        registerPacket(server, PacketDirection.OUT, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x39), PacketPlayerAbilitiesOut.class);
        registerPacket(server, PacketDirection.OUT, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x40), PacketKickDisconnect.class);
        registerPacket(server, PacketDirection.OUT, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x45), PacketTitle.class);
        registerPacket(server, PacketDirection.OUT, ConnectionState.PLAY, Map.of(new Version[]{Version.V1_8}, 0x47), PacketPlayerListHeaderFooter.class);
    }
